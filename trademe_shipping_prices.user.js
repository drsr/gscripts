...
function addShipping(card, listing) {
    // #DetailTabs version is new tabbed layout
    var shippingFirst = $("#AuctionSaleDetail_ShippingDetailsList li:first,#DetailTabs_ShippingDetailsTab_ShippingOptionList li:first", listing).text();
    if (shippingFirst) {
        ...
        var noPickups = $("#AuctionSaleDetail_ShippingDetailsList li:contains('Seller does not allow pick-ups'),#DetailTabs_ShippingDetailsTab_ShippingOptionList  li:contains('Seller does not allow pick-ups')", listing).length > 0;
        if (noPickups) {
            shippingPrice += "&nbsp;(NPU)";
        }
