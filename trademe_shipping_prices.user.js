...
function addShipping(card, listing) {
    ...
    var shippingFirst = myJQ("#AuctionSaleDetail_ShippingDetailsList li:first,.custom-shipping-price:first,,#shipping-options tbody tr:first,.tm-payment-pricing__shipping-options tbody tr:first,#ShippingDetails_FreeShipping,#ShippingDetails_MustPickup,#ShippingDetails_ToBeArranged", listing).text();
    if (shippingFirst) {
